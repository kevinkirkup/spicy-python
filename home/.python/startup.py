...
try:
    ...
    # OSX uses libedit for readline bindings
...
# Automatically add some convenience functions to builtins
import builtins
for n in autobuiltins:
    exec('builtins.__dict__["%s"] = %s' % (n,n), globals())
